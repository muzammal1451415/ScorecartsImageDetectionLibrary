...
public class ObjectDetection implements ObjectDetect {
     ...
     */
    public static ObjectDetection create(
            ...
            throws IOException {
        final ObjectDetection d = new ObjectDetection();
...
//        if (tfLite != null) tfLite.setUseNNAPI(isChecked);
    ...
    public ArrayList<Recognition> recognizeImage(Bitmap bitmap) {
        ...
        float[][][] out = new float[1][output_box][labels.size() + 5];
